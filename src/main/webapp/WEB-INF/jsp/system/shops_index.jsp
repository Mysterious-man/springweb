...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/system/skin/default/skin.css" rel="stylesheet" type="text/css" id="skin" />
...
<!--[if lt IE 9]>
<script src="${pageContext.request.contextPath}/resources/system/js/html5shiv.js"></script>
<script src="${pageContext.request.contextPath}/resources/system/js/respond.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/system/js/PIE/PIE_IE678.js"></script>
<![endif]-->
<body>
<div class="Sellerber" id="Sellerber">
    <!--顶部-->
    <div class="Sellerber_header apex clearfix" id="Sellerber_header">
        <div class="l_f logo header"><img src="${pageContext.request.contextPath}/resources/system/images/logo_03.png" /></div>
        <div class="r_f Columns_top clearfix header">
            ...
            <div class="administrator l_f">
                <img src="${pageContext.request.contextPath}/resources/system/images/avatar.png"  width="36px"/><span class="user-info">欢迎你,超级管理员</span><i class="glyph-icon fa  fa-caret-down"></i>
